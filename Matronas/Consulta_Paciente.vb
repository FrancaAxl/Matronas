...
Public Class Consulta_Paciente
    ...
    Private Sub Consulta_Paciente_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs)
        ...
        Dim idEmbarazada As Integer
        If Integer.TryParse(TextBox1.Text, idEmbarazada) Then
            Try
                ...
                ' Comando SQL
                comando = New SqlCommand("CP_FPEA_Select_Embarazada", conexion)
                comando.CommandType = CommandType.StoredProcedure
                comando.Parameters.AddWithValue("@ID_embarazada", idEmbarazada)
